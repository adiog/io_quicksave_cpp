...
public:
  ...
  InternalCreateRequestBean(CreateRequestBean createRequest,
                            std::string databaseConnectionString,
                            List<KeyBean> keys,
                            std::string storageConnectionString)
      : createRequest(createRequest),
        databaseConnectionString(databaseConnectionString), keys(keys),
        storageConnectionString(storageConnectionString) {}

  InternalCreateRequestBean(const rapidjson::Value &value) {
    if (value.HasMember(createRequest_label))
      this->createRequest =
          Typoid<CreateRequestBean>::FromValue(value[createRequest_label]);
    else
