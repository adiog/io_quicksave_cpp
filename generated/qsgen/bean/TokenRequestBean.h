...
#ifndef TOKENREQUESTBEAN_H
#define TOKENREQUESTBEAN_H
...
public:
  ...
  TokenRequestBean(int expireTime) : expireTime(expireTime) {}
  ...
  void update(TokenRequestBean bean) { expireTime = bean.expireTime; }
