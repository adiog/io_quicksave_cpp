...
#ifndef DATABASETASKBEAN_H
#define DATABASETASKBEAN_H
...
public:
  ...
  DatabaseTaskBean(SerializedDict beanjson, std::string beanname,
                   std::string databaseConnectionString, std::string type)
      : beanjson(beanjson), beanname(beanname),
        databaseConnectionString(databaseConnectionString), type(type) {}
