...
IO_QUICKSAVE_DB_MASTER = os.environ.get('IO_QUICKSAVE_DB_MASTER', '/io.quicksave.db/master.sqlite3')
IO_QUICKSAVE_DB_PRIVATE = os.environ.get('IO_QUICKSAVE_DB_PRIVATE', '/io.quicksave.db/private.sqlite3')
IO_QUICKSAVE_LOCUST_DATABASE = os.environ.get('IO_QUICKSAVE_LOCUST_DATABASE', '/io.quicksave.db/locust.sqlite3')
IO_QUICKSAVE_PYTHONPATH = os.environ.get('IO_QUICKSAVE_PYTHONPATH', '/io.quicksave.bootstrap/libbeans/pybeans/:/io.quicksave.bootstrap/plugin-engine:/io.quicksave.bootstrap/plugin-engine/pyengine:/io.quicksave.bootstrap/plugin-engine/pyasync')
...
IO_QUICKSAVE_CDN_PORT = int(os.environ.get('IO_QUICKSAVE_CDN_PORT', '13000'))
cdn_threads = int(os.environ.get('cdn_threads', '0'))
cdn_spdy_port = int(os.environ.get('cdn_spdy_port', '11001'))
cdn_h2_port = int(os.environ.get('cdn_h2_port', '11002'))
